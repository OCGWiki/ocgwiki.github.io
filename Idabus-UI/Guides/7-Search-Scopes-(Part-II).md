...
Now, doing a Page-Refresh will show the expected overview/list of Office Equipment:# Scenario
...
| text | A localizable string that is shown to the user to identify this scope. For this single language system no localization is required, so the instant string is defined as:<br>`Office Equipment` | localizable string |
